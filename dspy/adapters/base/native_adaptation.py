...
DEFAULT_NATIVE_RESPONSE_TYPES: list[type[NativeResponseFieldType]] = [Citations, Reasoning]


def ensure_native_response_type_parses_output(native_type: type[NativeResponseFieldType]) -> None:
...
def adapt_reasoning_native(task_spec: TaskSpec, field_name: str, lm: BaseLM, config: LMConfig) -> TaskSpec:
...
def adapt_citations_native(task_spec: TaskSpec, field_name: str, lm: BaseLM) -> TaskSpec:
